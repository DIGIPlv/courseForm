...
const courseNameTxt = document.getElementsByClassName(
...
function buyCourse(price) {
  switch (price) {
    case priceAlt:
      ...
      priceID = IDOpt[0];
      courseNameInput.value = courseNameTxt;
      break;
    case priceReg:
    ...
    case priceThird:
      ...
      priceID = IDOpt[2];
      courseNameInput.value = courseNameTxt + " – Ekstra";
      break;
    default:
      location.reload();
  }
...
var stripe = Stripe(
  "pk_live_51IExHcCegkqBtvRmaF2bwzdZGLCkC3z5jZTH7rLe8yYDytA9NSNsXNJRlv975sGydNjCJrbbUr8TNUdobNR4D2fy003F8G7V1Q"
);
...
for (let i = 0; i < radio.length; i++) {
  radio[i].addEventListener("change", (e) => {
    if (e.target.value == "Rēķins e-pastā") {
